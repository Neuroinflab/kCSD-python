...
def generate_csd_3D(csd_profile, states, 
                    start_x=0., end_x=1., 
                    start_y=0., end_y=1., 
                    start_z=0., end_z=1., 
                    res_x=50, res_y=50, 
    ...
    f = csd_profile(csd_x, csd_y, csd_z, states=states) 
...
def make_plots(save_as, fig_title, 
    ...
    levels_pot = np.linspace(-1*v_max, v_max, 15)
    ...
    levels_kcsd = np.linspace(-1*t_max, t_max, 15)
    ...
    #plt.title("Lambda,R,CV_Error,RMS_Error,Time = "+title)
    # #Showing/saving
    #plt.tight_layout()
    plt.show()
...
def main_loop(csd_seed, total_ele, num_init_srcs=1000):
    """
    ...
    # csd_profile = csd_profile_3d_basis
    # csd_name = 'basis'
    ...
    t_csd_x, t_csd_y, t_csd_z, true_csd = generate_csd_3D(csd_profile, 
                                                          start_x=0., end_x=1., 
                                                          start_y=0., end_y=1., 
                                                          start_z=0., end_z=1.,
                                                          res_x=100, res_y=100,
    ...
    chr_x, chr_y, chr_z, test_csd = generate_csd_3D(csd_profile, 
    ...
    make_plots(save_as, title, 
               ...
               ele_x, ele_y, ele_z, pots,
               k.space_X, k.space_Y, k.space_Z, est_csd) 
...
if __name__=='__main__':
    ...
    main_loop(csd_seed, total_ele, 1000)
