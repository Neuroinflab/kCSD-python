...
class TestKCSD2D(TestKCSD):
    ...
    def integrate(self, x, y, true_csd, xlin, ylin, csd_x, csd_y):
        """
...
#                     ', RMS=' + str(rms))
        ...
        ax2.contourf(kcsd.estm_x, kcsd.estm_y, mask, levels=levels2,
...
#                     format='%.2f')
        ...
        ax4.contourf(kcsd.estm_x, kcsd.estm_y, mask, levels=levels2,
                     alpha=0.3, cmap='Greys')
        ax4.set_xlabel('x [mm]')
#        ax4.set_ylabel('y [mm]')
...
if __name__ == '__main__':
    ...
    a = TestKCSD2D(csd_profile, csd_seed, total_ele=total_ele, h=50., sigma=1.,
                   config='broken', err_map='no', nr_basis=400)
