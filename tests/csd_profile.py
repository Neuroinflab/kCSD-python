...
def gauss_2d_error_map(x, y, R, xi, yi, source, seed=0):
...
def neat_4d_plot(x, y, z, t, chrg_x, chrg_y, z_steps=5, cmap=cm.bwr_r):
...
#    csd_profile = gauss_2d_error_map
    chrg_x, chrg_y = np.mgrid[0.:1.:100j,
                              0.:1.:100j]
    ...
    im = ax1.contourf(chrg_x, chrg_y, f, levels=levels, cmap=cm.bwr_r)
