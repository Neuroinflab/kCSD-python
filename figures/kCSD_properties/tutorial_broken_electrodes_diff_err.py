...
def generate_figure():
    ...
    gs.update(top=0.95, bottom=0.69)
    ...
    err_max = 0.2
    gs = gridspec.GridSpec(2, 4, height_ratios=[1.0, 0.04], width_ratios=[1] * 4)
    gs.update(top=0.63, bottom=0.37)
    ax = plt.subplot(gs[0, 0])
    cax = plt.subplot(gs[1, 0])
    make_subplot(
        ax,
    ...
    err_max = 0.2
    gs = gridspec.GridSpec(2, 4, height_ratios=[1.0, 0.04], width_ratios=[1] * 4)
    gs.update(top=0.31, bottom=0.05)
    ax = plt.subplot(gs[0, 0])
    cax = plt.subplot(gs[1, 0])
    make_subplot(
        ax,
...
def generate_figure2():
    ...
    make_subplot(
        ...
        ele_pos=electrode_positions(missing_ele=10),
        cax=cax,
        title="Error Diff CSD 10 broken",
        xlabel=True,
        letter="C",
        t_max=err_max,
    )
    ...
    make_subplot(
        ...
        ele_pos=electrode_positions(missing_ele=20),
        cax=cax,
        title="Error Diff CSD 20 broken",
        xlabel=True,
        letter="D",
        t_max=err_max,
    )
